...
//--------------------CHANGE------------------------------
//Implemented Langwith level
//--------------------/CHANGE------------------------------

public class LangwithCollege extends Level implements Screen{
	...
	private static String mapString = "JamesCollege/Langwith.tmx" ;
	...
	public LangwithCollege(DuckTator game){
		//Calling the LEVEL class constructor. Passing in the map!
		super(game, mapString,670,320,2);
